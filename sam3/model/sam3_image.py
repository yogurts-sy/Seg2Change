...
class Sam3Image(torch.nn.Module):
    ...
    def _get_img_feats(self, backbone_out, img_ids):
        ...
        if "backbone_fpn" in backbone_out:
            ...
            vis_feats = backbone_out["backbone_fpn"][-self.num_feature_levels :]           # [1, 256, 288, 288], [1, 256, 144, 144], [1, 256, 72, 72]
            ...
            img_feats = [x[img_ids].flatten(2).permute(2, 0, 1) for x in vis_feats]        # [5184, 1, 256]
            img_pos_embeds = [
